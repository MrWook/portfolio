...
router.get('/*', function(req, res, next) {
	...
	if(browserName == 'IE'){
		...
		res.sendFile('./public/main/ie.html', {root: req.rootPath});
		...
		res.sendFile('./public/main/update.html', {root: req.rootPath});
	}else{
		//load the single view file (angular will handle the page changes on the front-end)
		res.sendFile('./public/main/index.html', {root: req.rootPath});
	}
});
